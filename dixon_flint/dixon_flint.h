...
void perform_fq_matrix_row_operations_mvpoly_new(fq_mvpoly_t ***new_matrix, 
...
void fq_dixon_resultant(fq_mvpoly_t *result, fq_mvpoly_t *polys, 
    ...
    */
    ...
    if (matrix_size > 0) {
        ...
        det_method_t coeff_method = DET_METHOD_RECURSIVE; // DET_METHOD_RECURSIVE DET_METHOD_KRONECKER DET_METHOD_INTERPOLATION
