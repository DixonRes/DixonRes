...
A C implementation for computing Dixon resultants and solving polynomial systems over finite fields and The rationals \(\mathbb{Q}\), based on the FLINT and PML library.
...
| Feature | F_p | F_{p^k} | Q (`field_size=0`) |
|---|---|---|---|
| Dixon resultant | ✅ | ✅ | ✅ |
