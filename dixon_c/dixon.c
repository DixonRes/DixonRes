// gcc -O3 -march=native -o dixon dixon.c -lflint -lmpfr -lgmp -lpthread -L/home/suohaohai02/mylinks -lflint -lstdc++ -lpml2 -fopenmp
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(int argc, char *argv[]) {
    ...
    if (ideal_str && allvars_str) {
        ...
        // Suppress internal output if in silent mode or if specifically requested
