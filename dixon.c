...
static void print_usage(const char *prog_name) {
    ...
    printf("  Standard: 257, 256, 2^8, 3^5\n");
    printf("  Custom polynomial: 2^32: t^32 + t^15 + t^9 + t^7 + t^4 + t^3 + 1\n");
    printf("  (Variable name is auto-detected; defaults to 't' if no colon)\n");
    ...
    printf("\n");
    printf("  Extension field with custom polynomial:\n");
    printf("    %s \"x + y, x*y + 1\" \"x\" \"2^8: t^8 + t^4 + t^3 + t + 1\"\n", prog_name);
    printf("    (AES polynomial for F_256)\n\n");
